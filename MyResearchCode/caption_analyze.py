...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        print("please enter : python caption_anlyze.py <keyword> <result_num>")
        sys.exit()
    ...
    sys.stdout = open("result/"+keyword+"_"+result_num+"_result.txt", "w",encoding="utf-8")#!encoding delete
    ...
    with open("result/analyze_result.pkl", "wb") as pkl_file:
